...
The UK is not unique in experiencing much lower growth since the end of the Great Recession. In fact, most other advanced industrial nations including the USA, Germany, France and Italy have suffered similarly, and for the same reasons (almost certainly) as the UK. Take for example the US. Figure 3 shows the time path of log real GDP per head with the trend growth line for 1955Q1 to 2007Q4 superimposed. As can be seen the picture is very similar to that of the UK.
